...
//TODO: 3 types of settings, list, int ,, bool
class SettingsButton extends JButton {
    ...
    public SettingsButton(String t, String keyBinds, String control) {
        super(t + keyBinds);
        this.t = t;
    ...
    //i think a smart person would genuinely have a heart attack looking at this
    public void updateText() {
        ...
        try {
            ...
            this.setText(t + TetrisSettingsFrame.str(keys));
        } catch (Exception e) {
            System.out.println(e);
        }
...
public class TetrisSettingsFrame extends JPanel {
    ...
    public static String str(int[] list) { // there has to be a one line solution to this
